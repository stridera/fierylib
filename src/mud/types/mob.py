...
class Mob:
    ...
    def parse(cls, mob_file: MudData):
        ...
        for mob_data in mob_file.split_by_delimiter():
            ...
            # Provide default values for missing stats (13 is a typical default)
            stats.setdefault("strength", 13)
            stats.setdefault("intelligence", 13)
            stats.setdefault("wisdom", 13)
            stats.setdefault("dexterity", 13)
            stats.setdefault("constitution", 13)
            stats.setdefault("charisma", 13)
