...
class ClassImporter:
            ...
            try:
                ...
                await self.prisma.characterclass.create(
                    data={
                        ...
                        # plainName is auto-generated by middleware from name
    ...
    async def import_class_skills(
        ...
        for class_id, assignments in sorted(by_class.items()):
            ...
            # Get class from database by plainName (since that's unique and predictable)
            character_class = await self.prisma.characterclass.find_first(
                where={"plainName": class_name.title()}  # e.g., "sorcerer" -> "Sorcerer"
            )
