...
if world.count_mobiles(80, 31) < 1 and (actor.level < 30 or actor:get_quest_stage("dragon_slayer") == 3) then
    run_room_trigger(360, 6)
    ...
    get_room(160, 95):at(function()
        self.room:find_actor("ice"):teleport(get_room(80, rnd_room))
    end)
