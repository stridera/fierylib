...
if actor.is_player then
    if actor:get_quest_stage("sunfire_rescue") == 3 then
        if object.zone_id == 520 and object.local_id == 1 then
            -- Real elven ring -- completes the quest
            ...
            self:whisper(actor, "Thank you for your help!  Please wear this badge as a token of my respect.")
            self.room:send("A voice softly echos goodbye...")
            world.destroy(self.room:find_actor("serin"))
        end
        if object.zone_id == 520 and object.local_id == 18 then
            -- Cursed ring
