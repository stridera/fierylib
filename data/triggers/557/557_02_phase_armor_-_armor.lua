...
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <Phase Armor - Armor>:29: 'then' expected near '?'
...
elseif arms_name ~= speech then
    local name = "pair of " .. tostring(arms_name)
    local gem_id = arms_gem
    local armor_id = arms_armor
elseif legs_name ~= speech then
    local name = "pair of " .. tostring(legs_name)
