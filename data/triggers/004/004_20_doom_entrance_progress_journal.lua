...
if string.find(arg, "doom_entrance") or string.find(arg, "the_planes_of_doom") or string.find(arg, "planes_of_doom") or string.find(arg, "doom_entrance") or string.find(arg, "the_planes_of_doom") or string.find(arg, "planes_of_doom") or string.find(arg, "planes") then
