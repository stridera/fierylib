...
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <Major Sanctuary progress journal>:4: 'then' expected near 'Sanctuary'
--
...
if string.find(arg, "major") Sanctuary or string.find(arg, "major") sanc then
    _return_value = false
