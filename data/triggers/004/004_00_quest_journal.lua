...
if not arg then
    ...
    actor:send("Quests will be revealed in this journal as you become eligible to take them on.  There are main indexes organized around the type of quest, then detailed entries for each individual quest.")
