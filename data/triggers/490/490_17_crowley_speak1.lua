...
wait(2)
actor:send(tostring(self.name) .. " falls to the ground before you.")
self.room:send_except(actor, tostring(self.name) .. " falls to the ground before " .. tostring(actor.name) .. ".")
