...
if actor:has_equipped("1406") then
    ...
    if got_hall_open ~= 1 then
        ...
        doors.set_flags(get_room(23, 310), "north", "acd")
        doors.set_state(get_room(23, 310), "north", {action = "room"})
        doors.set_description(get_room(23, 310), "north", "A large archway leads into an inviting, stone structure.")
        ...
        -- create the other side and link
        doors.set_flags(get_room(23, 310), "north", "abcd")
        doors.set_state(get_room(23, 310), "north", {action = "room"})
        doors.set_name(get_room(23, 310), "north", "entry arch")
        doors.set_description(get_room(23, 310), "north", "The archway leading into the structure is protected by a force field.")
        get_room(23, 310):at(function()
