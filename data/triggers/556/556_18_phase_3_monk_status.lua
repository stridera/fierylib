-- Trigger: phase_3_monk_status
-- Zone: 556, ID: 18
-- Type: MOB, Flags: SPEECH_TO
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <phase_3_monk_status>:39: function arguments expected near ']'
--   Complex nesting: 26 if statements
--   Large script: 7694 chars
--
-- Original DG Script: #55618

-- Converted from DG Script #55618: phase_3_monk_status
...
local right_class = actor.class == Monk
local min_level = 41
local quest_stage = 2
if right_class then
    ...
    elseif actor:get_quest_stage("phase_armor") >= quest_stage then
        ...
        -- gems for this class
        local vnum_gem_gloves = 55674
        local vnum_gem_boots = 55685
        local vnum_gem_bracer = 55696
        local vnum_gem_helm = 55707
        local vnum_gem_arm = 55718
        local vnum_gem_legs = 55729
        local vnum_gem_chest = 55740
        -- rewards for this class
        local vnum_reward_helm = 55538
        local vnum_reward_arms = 55539
        local vnum_reward_chest = 55540
        local vnum_reward_legs = 55541
        local vnum_reward_boots = 55542
        local vnum_reward_bracer = 55543
        local vnum_reward_gloves = 55544
