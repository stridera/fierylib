-- Trigger: phase_3_druid_status
-- Zone: 556, ID: 19
-- Type: MOB, Flags: SPEECH_TO
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <phase_3_druid_status>:39: function arguments expected near ']'
--   Complex nesting: 26 if statements
--   Large script: 7696 chars
--
-- Original DG Script: #55619

-- Converted from DG Script #55619: phase_3_druid_status
...
local right_class = actor.class == Druid
local min_level = 41
local quest_stage = 2
if right_class then
    ...
    elseif actor:get_quest_stage("phase_armor") >= quest_stage then
        -- destroyed armor
        local vnum_destroyed_gloves = 55358
        local vnum_destroyed_boots = 55362
        local vnum_destroyed_bracer = 55366
        local vnum_destroyed_helm = 55370
        local vnum_destroyed_arm = 55374
        local vnum_destroyed_legs = 55378
        local vnum_destroyed_chest = 55382
        -- gems for this class
        local vnum_gem_gloves = 55673
        local vnum_gem_boots = 55684
        local vnum_gem_bracer = 55695
        local vnum_gem_helm = 55706
        local vnum_gem_arm = 55717
        local vnum_gem_legs = 55728
        local vnum_gem_chest = 55739
        -- rewards for this class
        local vnum_reward_helm = 55524
        local vnum_reward_arms = 55525
        local vnum_reward_chest = 55526
        local vnum_reward_legs = 55527
        local vnum_reward_boots = 55528
        local vnum_reward_bracer = 55529
        local vnum_reward_gloves = 55530
