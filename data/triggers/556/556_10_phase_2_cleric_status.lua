-- Trigger: phase_2_cleric_status
-- Zone: 556, ID: 10
-- Type: MOB, Flags: SPEECH_TO
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <phase_2_cleric_status>:8: unexpected symbol near '='
--   Complex nesting: 26 if statements
--   Large script: 7729 chars
--
-- Original DG Script: #55610

-- Converted from DG Script #55610: phase_2_cleric_status
...
local right_class = (actor.class /= Cleric)  or  (actor.class /= Priest)
local min_level = 21
local quest_stage = 2
if right_class then
    ...
    elseif actor:get_quest_stage("phase_armor") >= quest_stage then
        ...
        -- gems for this class
        local vnum_gem_gloves = 55601
        local vnum_gem_boots = 55612
        local vnum_gem_bracer = 55623
        local vnum_gem_helm = 55634
        local vnum_gem_arm = 55645
        local vnum_gem_legs = 55656
        local vnum_gem_chest = 55667
        -- rewards for this class
        local vnum_reward_helm = 55433
        local vnum_reward_arms = 55434
        local vnum_reward_chest = 55435
        local vnum_reward_legs = 55436
        local vnum_reward_boots = 55437
        local vnum_reward_bracer = 55438
        local vnum_reward_gloves = 55439
