-- Trigger: phase_3_diabolist_status
-- Zone: 556, ID: 30
-- Type: MOB, Flags: SPEECH_TO
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <phase_3_diabolist_status>:39: function arguments expected near ']'
--   Complex nesting: 26 if statements
--   Large script: 7704 chars
--
-- Original DG Script: #55630

-- Converted from DG Script #55630: phase_3_diabolist_status
...
local right_class = actor.class == Diabolist
local min_level = 41
local quest_stage = 2
if right_class then
    ...
    elseif actor:get_quest_stage("phase_armor") >= quest_stage then
        -- destroyed armor
        local vnum_destroyed_gloves = 55356
        local vnum_destroyed_boots = 55360
        local vnum_destroyed_bracer = 55364
        local vnum_destroyed_helm = 55368
        local vnum_destroyed_arm = 55372
        local vnum_destroyed_legs = 55376
        local vnum_destroyed_chest = 55380
        -- gems for this class
        local vnum_gem_gloves = 55672
        local vnum_gem_boots = 55683
        local vnum_gem_bracer = 55694
        local vnum_gem_helm = 55705
        local vnum_gem_arm = 55716
        local vnum_gem_legs = 55727
        local vnum_gem_chest = 55738
        -- rewards for this class
        local vnum_reward_helm = 55545
        local vnum_reward_arms = 55546
        local vnum_reward_chest = 55547
        local vnum_reward_legs = 55548
        local vnum_reward_boots = 55549
        local vnum_reward_bracer = 55550
        local vnum_reward_gloves = 55551
