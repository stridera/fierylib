-- Trigger: phase_1_sorcerer_status
-- Zone: 556, ID: 7
-- Type: MOB, Flags: SPEECH_TO
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <phase_1_sorcerer_status>:8: unexpected symbol near '='
--   Complex nesting: 26 if statements
--   Large script: 7840 chars
--
-- Original DG Script: #55607

-- Converted from DG Script #55607: phase_1_sorcerer_status
...
local right_class = (actor.class /= Sorcerer)  or  (actor.class /= Necromancer)  or  (actor.class /= Cryomancer)  or  (actor.class /= Pyromancer)  or  (actor.class /= Conjurer)
local min_level = 1
local quest_stage = 1
if right_class then
    ...
    elseif actor:get_quest_stage("phase_armor") >= quest_stage then
        ...
        local vnum_destroyed_gloves = 55302
        local vnum_destroyed_boots = 55306
        local vnum_destroyed_bracer = 55310
        local vnum_destroyed_helm = 55314
        local vnum_destroyed_arm = 55318
        local vnum_destroyed_legs = 55322
        local vnum_destroyed_chest = 55326
        -- gems for this class
        local vnum_gem_gloves = 55567
        local vnum_gem_boots = 55571
        local vnum_gem_bracer = 55575
        local vnum_gem_helm = 55579
        local vnum_gem_arm = 55583
        local vnum_gem_legs = 55587
        local vnum_gem_chest = 55591
        -- rewards for this class
        local vnum_reward_helm = 55398
        local vnum_reward_arms = 55399
        local vnum_reward_chest = 55400
        local vnum_reward_legs = 55401
        local vnum_reward_boots = 55402
        local vnum_reward_bracer = 55403
        local vnum_reward_gloves = 55404
