-- Trigger: phase_2_diabolist_status
-- Zone: 556, ID: 23
-- Type: MOB, Flags: SPEECH_TO
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <phase_2_diabolist_status>:34: function arguments expected near ']'
--   Complex nesting: 25 if statements
--   Large script: 7631 chars
--
-- Original DG Script: #55623

-- Converted from DG Script #55623: phase_2_diabolist_status
...
if right_class then
    ...
    elseif actor:get_quest_stage("phase_armor") >= quest_stage then
        -- destroyed armor
        local vnum_destroyed_gloves = 55328
        local vnum_destroyed_boots = 55332
        local vnum_destroyed_bracer = 55336
        local vnum_destroyed_helm = 55340
        local vnum_destroyed_arm = 55344
        local vnum_destroyed_legs = 55348
        local vnum_destroyed_chest = 55352
        -- gems for this class
        local vnum_gem_gloves = 55595
        local vnum_gem_boots = 55606
        local vnum_gem_bracer = 55617
        local vnum_gem_helm = 55628
        local vnum_gem_arm = 55639
        local vnum_gem_legs = 55650
        local vnum_gem_chest = 55661
        -- rewards for this class
        local vnum_reward_helm = 55468
        local vnum_reward_arms = 55469
        local vnum_reward_chest = 55470
        local vnum_reward_legs = 55471
        local vnum_reward_boots = 55472
        local vnum_reward_bracer = 55473
        local vnum_reward_gloves = 55474
