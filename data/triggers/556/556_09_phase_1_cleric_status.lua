-- Trigger: phase_1_cleric_status
-- Zone: 556, ID: 9
-- Type: MOB, Flags: SPEECH_TO
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <phase_1_cleric_status>:8: unexpected symbol near '='
--   Complex nesting: 26 if statements
--   Large script: 7788 chars
--
-- Original DG Script: #55609

-- Converted from DG Script #55609: phase_1_cleric_status
...
local right_class = (actor.class /= Cleric)  or  (actor.class /= Priest)  or  (actor.class /= Diabolist)  or  (actor.class /= Druid)
local min_level = 1
local quest_stage = 1
if right_class then
    ...
    elseif actor:get_quest_stage("phase_armor") >= quest_stage then
        ...
        local id_reward_helm = 55391
        local id_reward_arms = 55392
        local id_reward_chest = 55393
        local id_reward_legs = 55394
        local id_reward_boots = 55395
        local id_reward_bracer = 55396
        local id_reward_gloves = 55397
