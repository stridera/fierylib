...
if right_class then
    ...
    elseif actor:get_quest_stage("phase_armor") >= quest_stage then
        ...
        -- gems for this class
        local vnum_gem_gloves = 55602
        local vnum_gem_boots = 55613
        local vnum_gem_bracer = 55624
        local vnum_gem_helm = 55631
        local vnum_gem_arm = 55646
        local vnum_gem_legs = 55657
        local vnum_gem_chest = 55668
