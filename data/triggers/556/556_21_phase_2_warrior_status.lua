-- Trigger: phase_2_warrior_status
-- Zone: 556, ID: 21
-- Type: MOB, Flags: SPEECH_TO
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <phase_2_warrior_status>:39: function arguments expected near ']'
--   Complex nesting: 26 if statements
--   Large script: 7700 chars
--
-- Original DG Script: #55621

-- Converted from DG Script #55621: phase_2_warrior_status
...
if right_class then
    ...
    elseif actor:get_quest_stage("phase_armor") >= quest_stage then
        ...
        -- gems for this class
        local vnum_gem_gloves = 55604
        local vnum_gem_boots = 55615
        local vnum_gem_bracer = 55626
        local vnum_gem_helm = 55637
        local vnum_gem_arm = 55648
        local vnum_gem_legs = 55659
        local vnum_gem_chest = 55670
        -- rewards for this class
        local vnum_reward_helm = 55412
        local vnum_reward_arms = 55413
        local vnum_reward_chest = 55414
        local vnum_reward_legs = 55415
        local vnum_reward_boots = 55416
        local vnum_reward_bracer = 55417
        local vnum_reward_gloves = 55418
