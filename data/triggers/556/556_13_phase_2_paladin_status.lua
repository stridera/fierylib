-- Trigger: phase_2_paladin_status
-- Zone: 556, ID: 13
-- Type: MOB, Flags: SPEECH_TO
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <phase_2_paladin_status>:39: function arguments expected near ']'
--   Complex nesting: 26 if statements
--   Large script: 7700 chars
--
-- Original DG Script: #55613

-- Converted from DG Script #55613: phase_2_paladin_status
...
if right_class then
    ...
    elseif actor:get_quest_stage("phase_armor") >= quest_stage then
        ...
        -- gems for this class
        local vnum_gem_gloves = 55599
        local vnum_gem_boots = 55610
        local vnum_gem_bracer = 55621
        local vnum_gem_helm = 55632
        local vnum_gem_arm = 55643
        local vnum_gem_legs = 55654
        local vnum_gem_chest = 55665
        -- rewards for this class
        local vnum_reward_helm = 55419
        local vnum_reward_arms = 55420
        local vnum_reward_chest = 55421
        local vnum_reward_legs = 55422
        local vnum_reward_boots = 55423
        local vnum_reward_bracer = 55424
        local vnum_reward_gloves = 55425
