-- Trigger: phase_1_rogue_status
-- Zone: 556, ID: 8
-- Type: MOB, Flags: SPEECH_TO
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <phase_1_rogue_status>:8: unexpected symbol near '='
--   Complex nesting: 26 if statements
--   Large script: 7788 chars
--
-- Original DG Script: #55608

-- Converted from DG Script #55608: phase_1_rogue_status
...
local right_class = (actor.class /= Rogue)  or  (actor.class /= Assassin)  or  (actor.class /= Thief)  or  (actor.class /= Mercenary)
local min_level = 1
local quest_stage = 1
if right_class then
    ...
    elseif actor:get_quest_stage("phase_armor") >= quest_stage then
        -- destroyed armor
        local vnum_destroyed_gloves = 55301
        local vnum_destroyed_chest = 55325
        local vnum_destroyed_boots = 55305
        local vnum_destroyed_bracer = 55309
        local vnum_destroyed_helm = 55313
        local vnum_destroyed_arm = 55317
        local vnum_destroyed_legs = 55321
        -- gems for this class
        local vnum_gem_gloves = 55568
        local vnum_gem_boots = 55572
        local vnum_gem_bracer = 55576
        local vnum_gem_helm = 55580
        local vnum_gem_arm = 55584
        local vnum_gem_legs = 55588
        local vnum_gem_chest = 55592
        -- rewards for this class
        local vnum_reward_helm = 55405
        local vnum_reward_arms = 55406
        local vnum_reward_chest = 55407
        local vnum_reward_legs = 55408
        local vnum_reward_boots = 55409
        local vnum_reward_bracer = 55410
        local vnum_reward_gloves = 55411
