-- Trigger: phase_2_necromancer_status
-- Zone: 556, ID: 15
-- Type: MOB, Flags: SPEECH_TO
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <phase_2_necromancer_status>:39: function arguments expected near ']'
--   Complex nesting: 26 if statements
--   Large script: 7708 chars
--
-- Original DG Script: #55615

-- Converted from DG Script #55615: phase_2_necromancer_status
...
local right_class = actor.class == Necromancer
local min_level = 21
local quest_stage = 2
if right_class then
    ...
    elseif actor:get_quest_stage("phase_armor") >= quest_stage then
        -- destroyed armor
        local vnum_destroyed_gloves = 55331
        local vnum_destroyed_boots = 55335
        local vnum_destroyed_bracer = 55339
        local vnum_destroyed_helm = 55343
        local vnum_destroyed_arm = 55347
        local vnum_destroyed_legs = 55351
        local vnum_destroyed_chest = 55355
        -- gems for this class
        local vnum_gem_gloves = 55598
        local vnum_gem_boots = 55609
        local vnum_gem_bracer = 55620
        local vnum_gem_helm = 55631
        local vnum_gem_arm = 55642
        local vnum_gem_legs = 55653
        local vnum_gem_chest = 55664
        -- rewards for this class
        local vnum_reward_helm = 55454
        local vnum_reward_arms = 55455
        local vnum_reward_chest = 55456
        local vnum_reward_legs = 55457
        local vnum_reward_boots = 55458
        local vnum_reward_bracer = 55459
        local vnum_reward_gloves = 55460
