-- Trigger: phase_2_monk_status
-- Zone: 556, ID: 14
-- Type: MOB, Flags: SPEECH_TO
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <phase_2_monk_status>:39: function arguments expected near ']'
--   Complex nesting: 26 if statements
--   Large script: 7694 chars
--
-- Original DG Script: #55614

-- Converted from DG Script #55614: phase_2_monk_status
...
if right_class then
    ...
    elseif actor:get_quest_stage("phase_armor") >= quest_stage then
        ...
        -- gems for this class
        local vnum_gem_gloves = 55597
        local vnum_gem_boots = 55608
        local vnum_gem_bracer = 55619
        local vnum_gem_helm = 55630
        local vnum_gem_arm = 55641
        local vnum_gem_legs = 55652
        local vnum_gem_chest = 55663
        -- rewards for this class
        local vnum_reward_helm = 55461
        local vnum_reward_arms = 55462
        local vnum_reward_chest = 55463
        local vnum_reward_legs = 55464
        local vnum_reward_boots = 55465
        local vnum_reward_bracer = 55466
        local vnum_reward_gloves = 55467
