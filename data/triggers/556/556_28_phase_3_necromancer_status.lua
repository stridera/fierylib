-- Trigger: phase_3_necromancer_status
-- Zone: 556, ID: 28
-- Type: MOB, Flags: SPEECH_TO
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <phase_3_necromancer_status>:39: function arguments expected near ']'
--   Complex nesting: 26 if statements
--   Large script: 7708 chars
--
-- Original DG Script: #55628

-- Converted from DG Script #55628: phase_3_necromancer_status
...
if right_class then
    ...
    elseif actor:get_quest_stage("phase_armor") >= quest_stage then
        ...
        -- gems for this class
        local vnum_gem_gloves = 55675
        local vnum_gem_boots = 55686
        local vnum_gem_bracer = 55697
        local vnum_gem_helm = 55708
        local vnum_gem_arm = 55719
        local vnum_gem_legs = 55730
        local vnum_gem_chest = 55741
        -- rewards for this class
        local vnum_reward_helm = 55531
        local vnum_reward_arms = 55532
        local vnum_reward_chest = 55533
        local vnum_reward_legs = 55534
        local vnum_reward_boots = 55535
        local vnum_reward_bracer = 55536
        local vnum_reward_gloves = 55537
