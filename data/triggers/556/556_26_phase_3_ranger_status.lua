-- Trigger: phase_3_ranger_status
-- Zone: 556, ID: 26
-- Type: MOB, Flags: SPEECH_TO
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <phase_3_ranger_status>:39: function arguments expected near ']'
--   Complex nesting: 26 if statements
--   Large script: 7698 chars
--
-- Original DG Script: #55626

-- Converted from DG Script #55626: phase_3_ranger_status
...
local right_class = actor.class == Ranger
local min_level = 41
local quest_stage = 2
if right_class then
    ...
    elseif actor:get_quest_stage("phase_armor") >= quest_stage then
        ...
        local id_reward_helm = 55517
        local id_reward_arms = 55518
        local id_reward_chest = 55519
        local id_reward_legs = 55520
        local id_reward_boots = 55521
        local id_reward_bracer = 55522
        local id_reward_gloves = 55523
