-- Trigger: phase_3_sorcerer_status
-- Zone: 556, ID: 29
-- Type: MOB, Flags: SPEECH_TO
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <phase_3_sorcerer_status>:39: function arguments expected near ']'
--   Complex nesting: 26 if statements
--   Large script: 7764 chars
--
-- Original DG Script: #55629

-- Converted from DG Script #55629: phase_3_sorcerer_status
...
local right_class = actor.class == Sorcerer  or  actor.class == Pyromancer  or  actor.class == Cryomancer
local min_level = 41
local quest_stage = 2
if right_class then
    ...
    elseif actor:get_quest_stage("phase_armor") >= quest_stage then
        -- destroyed armor
        local vnum_destroyed_gloves = 55359
        local vnum_destroyed_boots = 55363
        local vnum_destroyed_bracer = 55367
        local vnum_destroyed_helm = 55371
        local vnum_destroyed_arm = 55375
        local vnum_destroyed_legs = 55379
        local vnum_destroyed_chest = 55383
        -- gems for this class
        local vnum_gem_gloves = 55679
        local vnum_gem_boots = 55690
        local vnum_gem_bracer = 55701
        local vnum_gem_helm = 55712
        local vnum_gem_arm = 55723
        local vnum_gem_legs = 55734
        local vnum_gem_chest = 55745
        -- rewards for this class
        local vnum_reward_helm = 55552
        local vnum_reward_arms = 55553
        local vnum_reward_chest = 55554
        local vnum_reward_legs = 55555
        local vnum_reward_boots = 55556
        local vnum_reward_bracer = 55557
        local vnum_reward_gloves = 55558
