...
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <**UNUSED**>:39: function arguments expected near ']'
--   Complex nesting: 26 if statements
--   Large script: 7714 chars
--
-- Original DG Script: #55627

-- Converted from DG Script #55627: **UNUSED**
...
if right_class then
    ...
    elseif actor:get_quest_stage("phase_armor") >= quest_stage then
        ...
        -- gems for this class
        local vnum_gem_gloves = 55678
        local vnum_gem_boots = 55689
        local vnum_gem_bracer = 55700
        local vnum_gem_helm = 55711
        local vnum_gem_arm = 55722
        local vnum_gem_legs = 55733
        local vnum_gem_chest = 55744
        -- rewards for this class
        local vnum_reward_helm = 55510
        local vnum_reward_arms = 55511
        local vnum_reward_chest = 55512
        local vnum_reward_legs = 55513
        local vnum_reward_boots = 55514
        local vnum_reward_bracer = 55515
        local vnum_reward_gloves = 55516
