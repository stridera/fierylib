-- Trigger: phase_2_druid_status
-- Zone: 556, ID: 11
-- Type: MOB, Flags: SPEECH_TO
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <phase_2_druid_status>:8: unexpected symbol near '='
--   Complex nesting: 26 if statements
--   Large script: 7696 chars
--
-- Original DG Script: #55611

-- Converted from DG Script #55611: phase_2_druid_status
