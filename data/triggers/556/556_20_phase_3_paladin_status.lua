-- Trigger: phase_3_paladin_status
-- Zone: 556, ID: 20
-- Type: MOB, Flags: SPEECH_TO
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <phase_3_paladin_status>:39: function arguments expected near ']'
--   Complex nesting: 26 if statements
--   Large script: 7700 chars
--
-- Original DG Script: #55620

-- Converted from DG Script #55620: phase_3_paladin_status
...
local right_class = actor.class == Paladin
local min_level = 41
local quest_stage = 2
if right_class then
    ...
    elseif actor:get_quest_stage("phase_armor") >= quest_stage then
        ...
        -- gems for this class
        local vnum_gem_gloves = 55676
        local vnum_gem_boots = 55687
        local vnum_gem_bracer = 55698
        local vnum_gem_helm = 55709
        local vnum_gem_arm = 55720
        local vnum_gem_legs = 55731
        local vnum_gem_chest = 55742
        -- rewards for this class
        local vnum_reward_helm = 55496
        local vnum_reward_arms = 55497
        local vnum_reward_chest = 55498
        local vnum_reward_legs = 55499
        local vnum_reward_boots = 55500
        local vnum_reward_bracer = 55501
        local vnum_reward_gloves = 55502
