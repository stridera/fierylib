...
elseif stage == 5 then
    if object.id == 18515 or object.id == 18516 or object.id == 18517 or object.id == 18518 or object.id == 18519 or object.id == 18520 then
        if actor:get_quest_var("group_heal:" .. tostring(object.zone_id) .. "_" .. tostring(object.local_id)) == 1 then
            _return_value = true
            wait(2)
            self:command("shake")
            ...
            actor:set_quest_var("group_heal", (tostring(object.zone_id) .. "_" .. tostring(object.local_id)), 1)
