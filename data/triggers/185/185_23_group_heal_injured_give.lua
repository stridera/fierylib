...
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <group_heal_injured_give>:10: function arguments expected near '.'
--
...
if actor:get_quest_stage("group_heal") == 6 then
    ...
    if victim.is_player then
        ...
        _return_value = true
        if actor:get_quest_var("group_heal:" .. tostring(victim.zone_id) .. "_" .. tostring(victim.local_id)) then
