-- Trigger: rogue_phase_3
-- Zone: 555, ID: 50
-- Type: MOB, Flags: RECEIVE
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <rogue_phase_3>:111: function arguments expected near ']'
--   Complex nesting: 15 if statements
--   Large script: 10498 chars
--
-- Original DG Script: #55550

-- Converted from DG Script #55550: rogue_phase_3
...
if (actor.class == "rogue" or actor.class == "thief" or actor.class == "assassin" or actor.class == "mercenary") and actor.level >= 41 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    -- destroyed armor
    local id_destroyed_gloves = 55357
    local id_destroyed_boots = 55361
    local id_destroyed_bracer = 55365
    local id_destroyed_helm = 55369
    local id_destroyed_arm = 55373
    local id_destroyed_legs = 55377
    local id_destroyed_chest = 55381
    -- gems for this class
    local id_gem_gloves = 55680
    local id_gem_boots = 55691
    local id_gem_bracer = 55702
    local id_gem_helm = 55713
    local id_gem_arm = 55724
    local id_gem_legs = 55735
    local id_gem_chest = 55746
    -- rewards for this class
    local id_reward_helm = 59
    local id_reward_arms = 60
    local id_reward_chest = 61
    local id_reward_legs = 62
    local id_reward_boots = 63
    local id_reward_bracer = 64
    local id_reward_gloves = 65
    -- 
