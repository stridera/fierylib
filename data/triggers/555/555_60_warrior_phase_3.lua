-- Trigger: warrior_phase_3
-- Zone: 555, ID: 60
-- Type: MOB, Flags: RECEIVE
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <warrior_phase_3>:112: function arguments expected near ']'
--   Complex nesting: 15 if statements
--   Large script: 10437 chars
--
-- Original DG Script: #55560

-- Converted from DG Script #55560: warrior_phase_3
...
if actor.class == "class" and actor.level >= 41 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    -- gems for this class
    local id_gem_gloves = 55681
    local id_gem_boots = 55692
    local id_gem_bracer = 55703
    local id_gem_helm = 55714
    local id_gem_arm = 55725
    local id_gem_legs = 55736
    local id_gem_chest = 55747
    -- rewards for this class
    local id_reward_helm = 89
    local id_reward_arms = 90
    local id_reward_chest = 91
    local id_reward_legs = 92
    local id_reward_boots = 93
    local id_reward_bracer = 94
    local id_reward_gloves = 95
    -- 
