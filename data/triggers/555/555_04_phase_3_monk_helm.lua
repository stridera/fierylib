-- Trigger: phase_3_monk_helm
-- Zone: 555, ID: 4
-- Type: MOB, Flags: SPEECH_TO
-- Status: CLEAN
--
-- Original DG Script: #55504

-- Converted from DG Script #55504: phase_3_monk_helm
...
if actor.class == "monk" and actor.level >= 41 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    actor:send(tostring(self.name) .. " tells you, \"but I'll need 3 cursed toapzs, and a Corroded Cap.\"")
