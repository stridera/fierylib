-- Trigger: phase_3_necromancer_gauntlets
-- Zone: 555, ID: 15
-- Type: MOB, Flags: SPEECH_TO
-- Status: CLEAN
--
-- Original DG Script: #55515

-- Converted from DG Script #55515: phase_3_necromancer_gauntlets
...
if actor.class == "necromancer" and actor.level >= 41 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    actor:send(tostring(self.name) .. " tells you, \"necromancer types but I'll need 3 handfulls of amythests, and a set\"")
