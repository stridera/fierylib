-- Trigger: phase_3_warrior_gauntlets
-- Zone: 555, ID: 55
-- Type: MOB, Flags: SPEECH_TO
-- Status: CLEAN
--
-- Original DG Script: #55555

-- Converted from DG Script #55555: phase_3_warrior_gauntlets
...
if actor.class == "warrior" and actor.level >= 41 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    actor:send(tostring(self.name) .. " tells you, \"warrior types but I'll need 3 uncut emeralds, and\"")
