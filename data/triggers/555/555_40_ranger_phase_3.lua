...
if actor.class == "class" and actor.level >= 41 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    local vnum_reward_helm = 17
    local vnum_reward_arms = 18
    local vnum_reward_chest = 19
    local vnum_reward_legs = 20
    local vnum_reward_boots = 21
    local vnum_reward_bracer = 22
    local vnum_reward_gloves = 23
    -- 
