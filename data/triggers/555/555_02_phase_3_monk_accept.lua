-- Trigger: Phase_3_monk_accept
-- Zone: 555, ID: 2
-- Type: MOB, Flags: SPEECH_TO
-- Status: CLEAN
--
-- Original DG Script: #55502

-- Converted from DG Script #55502: Phase_3_monk_accept
...
if actor.class == "monk" then
    ...
    actor:send(tostring(self.name) .. " tells you, \"Excellent, I can make nice boots, a cap, fistwraps,\"")
