-- Trigger: phase_3_rogue_greet
-- Zone: 555, ID: 41
-- Type: MOB, Flags: GREET
-- Status: CLEAN
--
-- Original DG Script: #55541

-- Converted from DG Script #55541: phase_3_rogue_greet
-- Original: MOB trigger, flags: GREET, probability: 100%
wait(2)
if (actor.class == "rogue" or actor.class == "thief" or actor.class == "assassin" or actor.class == "mercenary") and actor.level >= 41 then
