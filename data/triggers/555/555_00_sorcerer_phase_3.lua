...
--
-- Original DG Script: #55500

-- Converted from DG Script #55500: sorcerer_phase_3
...
if (actor.class == "sorcerer" or actor.class == "cryomancer" or actor.class == "pyromancer") and actor.level >= 41 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    -- gems for this class
    local id_gem_gloves = 55679
    local id_gem_boots = 55690
    local id_gem_bracer = 55701
    local id_gem_helm = 55712
    local id_gem_arm = 55723
    local id_gem_legs = 55734
    local id_gem_chest = 55745
    -- rewards for this class
    local id_reward_helm = 52
    local id_reward_arms = 53
    local id_reward_chest = 54
    local id_reward_legs = 55
    local id_reward_boots = 56
    local id_reward_bracer = 57
    local id_reward_gloves = 58
    -- 
