-- Trigger: necromancer_phase_3
-- Zone: 555, ID: 20
-- Type: MOB, Flags: RECEIVE
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <necromancer_phase_3>:112: function arguments expected near ']'
--   Complex nesting: 15 if statements
--   Large script: 10445 chars
--
-- Original DG Script: #55520

-- Converted from DG Script #55520: necromancer_phase_3
...
if actor.class == "class" and actor.level >= 41 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    -- destroyed armor
    local id_destroyed_gloves = 55359
    local id_destroyed_boots = 55363
    local id_destroyed_bracer = 55367
    local id_destroyed_helm = 55371
    local id_destroyed_arm = 55375
    local id_destroyed_legs = 55379
    local id_destroyed_chest = 55383
    -- gems for this class
    local id_gem_gloves = 55675
    local id_gem_boots = 55686
    local id_gem_bracer = 55697
    local id_gem_helm = 55708
    local id_gem_arm = 55719
    local id_gem_legs = 55730
    local id_gem_chest = 55741
    -- rewards for this class
    local id_reward_helm = 31
    local id_reward_arms = 32
    local id_reward_chest = 33
    local id_reward_legs = 34
    local id_reward_boots = 35
    local id_reward_bracer = 36
    local id_reward_gloves = 37
    -- 
    ...
    if not is_armor then
        ...
        if gems == 3 and actor.quest_variable[phase_armor:team_a_idrmor_armor_acquired] == 1 then
            ...
            wait(1)
            self.room:spawn_object(555, id_reward)
            wait(1)
            -- 
            -- loop for exp award.
            -- 
