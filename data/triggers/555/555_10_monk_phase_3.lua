...
if actor.class == "class" and actor.level >= 41 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    local vnum_reward_helm = 38
    local vnum_reward_arms = 39
    local vnum_reward_chest = 40
    local vnum_reward_legs = 41
    local vnum_reward_boots = 42
    local vnum_reward_bracer = 43
    local vnum_reward_gloves = 44
    -- 
