-- Trigger: monk_phase_3
-- Zone: 555, ID: 10
-- Type: MOB, Flags: RECEIVE
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <monk_phase_3>:112: function arguments expected near ']'
--   Complex nesting: 15 if statements
--   Large script: 10431 chars
--
-- Original DG Script: #55510

-- Converted from DG Script #55510: monk_phase_3
...
if actor.class == "class" and actor.level >= 41 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    -- gems for this class
    local id_gem_gloves = 55674
    local id_gem_boots = 55685
    local id_gem_bracer = 55696
    local id_gem_helm = 55707
    local id_gem_arm = 55718
    local id_gem_legs = 55729
    local id_gem_chest = 55740
    -- rewards for this class
    local id_reward_helm = 38
    local id_reward_arms = 39
    local id_reward_chest = 40
    local id_reward_legs = 41
    local id_reward_boots = 42
    local id_reward_bracer = 43
    local id_reward_gloves = 44
    -- 
