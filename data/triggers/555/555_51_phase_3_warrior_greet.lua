-- Trigger: phase_3_warrior_greet
-- Zone: 555, ID: 51
-- Type: MOB, Flags: GREET
-- Status: CLEAN
--
-- Original DG Script: #55551

-- Converted from DG Script #55551: phase_3_warrior_greet
-- Original: MOB trigger, flags: GREET, probability: 100%
wait(2)
if actor.class == "warrior" and actor.level >= 41 then
