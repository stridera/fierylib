-- Trigger: phase_3_ranger_vambraces
-- Zone: 555, ID: 36
-- Type: MOB, Flags: SPEECH_TO
-- Status: CLEAN
--
-- Original DG Script: #55536

-- Converted from DG Script #55536: phase_3_ranger_vambraces
...
if actor.class == "ranger" and actor.level >= 41 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    actor:send(tostring(self.name) .. " tells you, \"the ranger types but I'll need 3 parfect garnets, and\"")
