...
-- Status: CLEAN
--   Note: Displays reward list for Eldorian Guard faction
--
...
if actor.alignment >= -150 then
    if actor:get_quest_stage("Black_Legion") > 0 then
        ...
        if actor:get_quest_var("black_legion:eg_faction") >= 20 then
            ...
            actor:send("- <b:yellow>" .. obj_name(vnum_3eg_food) .. "</> for <magenta>" .. obj_name(vnum_gem_3eg_food) .. ".</>")
            actor:send("- <b:yellow>" .. obj_name(vnum_3eg_drink) .. "</> for <magenta>" .. obj_name(vnum_gem_3eg_drink) .. ".</>")
            actor:send("- <b:yellow>" .. obj_name(vnum_3eg_cap) .. "</> for <magenta>" .. obj_name(vnum_gem_3eg_cap) .. ".</>")
            actor:send("- <b:yellow>" .. obj_name(vnum_3eg_ssword) .. "</> for <magenta>" .. obj_name(vnum_gem_3eg_ssword) .. ".</>")
        end
        if actor:get_quest_var("black_legion:eg_faction") >= 40 then
            actor:send("- <b:yellow>" .. obj_name(vnum_3eg_neck) .. "</> for <magenta>" .. obj_name(vnum_gem_3eg_neck) .. ".</>")
            actor:send("- <b:yellow>" .. obj_name(vnum_3eg_staff) .. "</> for <magenta>" .. obj_name(vnum_gem_3eg_staff) .. ".</>")
        end
        if actor:get_quest_var("black_legion:eg_faction") >= 55 then
            actor:send("- <b:yellow>" .. obj_name(vnum_3eg_arm) .. "</> for <magenta>" .. obj_name(vnum_gem_3eg_arm) .. ".</>")
            actor:send("- <b:yellow>" .. obj_name(vnum_3eg_whammer) .. "</> for <magenta>" .. obj_name(vnum_gem_3eg_whammer) .. ".</>")
        end
        if actor:get_quest_var("black_legion:eg_faction") >= 70 then
            actor:send("- <b:yellow>" .. obj_name(vnum_3eg_wrist) .. "</> for <magenta>" .. obj_name(vnum_gem_3eg_wrist) .. ".</>")
            actor:send("- <b:yellow>" .. obj_name(vnum_3eg_flail) .. "</> for <magenta>" .. obj_name(vnum_gem_3eg_flail) .. ".</>")
        end
        if actor:get_quest_var("black_legion:eg_faction") < 70 then
