...
-- Status: CLEAN
--
-- p3 (tier 3) Black Legion mob death drop. Has a 90% chance to drop one
-- of the four 3bl-side trophies (zone 55, ids 9/11/13/15) into the room
-- for Eldorian Guard players to turn in via 041_07.
