...
-- Status: CLEAN
--
-- Initiates a player into the Eldorian Guard side of the Black_Legion quest
-- (3eg variant -- raid Split Skull to curry favor). Players already pledged
-- to the Black Legion (bl_ally) are turned away.
--
-- Original DG Script: #4106

-- Speech keywords: quest sod undead masses hi hello yes
local speech_lower = string.lower(speech)
if not (string.find(speech_lower, "quest") or string.find(speech_lower, "sod") or string.find(speech_lower, "undead") or string.find(speech_lower, "masses") or string.find(speech_lower, "hi") or string.find(speech_lower, "hello") or string.find(speech_lower, "yes")) then
