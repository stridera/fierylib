...
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <phase wand command imbue>:88: function arguments expected near ']'
...
if actor.room == "place" then
    if not actor:get_quest_var("type_wand:wandtask1") then
        ...
        if self.id == 306 or self.id == 316 or self.id == 326 or self.id == 336 then
            if actor:get_quest_var("type_wand:wandtask5") then
        ...
        elseif self.id == 308 or self.id == 318 or self.id == 328 or self.id == 338 then
            if actor:get_quest_var("type_wand:wandtask4") then
...
elseif self.id == 303 then
    if actor.room >= 55001 and actor.room <= 55003 and actor:get_quest_var("type_wand:greet") == 1 then
        local continue = "yes"
    else
        _return_value = true
    end
elseif self.id == 313 then
    if actor.room >= 5200 and actor.room <= 5299 and actor:get_quest_var("type_wand:greet") == 1 then
        local continue = "yes"
    else
        _return_value = true
    end
elseif self.id == 323 then
    if actor.room >= 39001 and actor.room <= 39189 and actor:get_quest_var("type_wand:greet") == 1 then
        local continue = "yes"
    else
        _return_value = true
    end
elseif self.id == 333 then
    if actor.room >= 7300 and actor.room <= 7457 and actor:get_quest_var("type_wand:greet") == 1 then
        local continue = "yes"
    else
        _return_value = true
    end
