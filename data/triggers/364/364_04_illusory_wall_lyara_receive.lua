...
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <illusory_wall_lyara_receive>:9: function arguments expected near '.'
--
...
if actor:get_quest_stage("illusory_wall") == 1 then
    ...
    if actor:get_quest_var("illusory_wall:" .. tostring(object.zone_id) .. "_" .. tostring(object.local_id)) == 1 then
        _return_value = true
        wait(1)
    ...
    elseif (item1 == 1 and object.id == 10307) or (item2 == 1 and object.id == 18511) then
        ...
        if object.id == 10307 or object.id == 18511 then
            actor:set_quest_var("illusory_wall", (tostring(object.zone_id) .. "_" .. tostring(object.local_id)), 1)
            wait(2)
