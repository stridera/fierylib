...
wait(2)
zone.echo(123, "<b:white>Beams of <yellow>light <white>shoot up from the menhirs meet and unite above the altar.</>")
...
wait(3)
self.room:send(tostring(mobiles.template(123, 1).name) .. " says, 'Chant it with us!'")
