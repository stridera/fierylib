...
if string.find(speech, "assist") or string.find(speech, "assistance") or string.find(speech, "how can i help") or string.find(speech, "how can i assist") or string.find(speech, "what can i do") then
    wait(2)
