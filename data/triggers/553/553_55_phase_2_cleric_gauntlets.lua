-- Trigger: phase_2_cleric_gauntlets
-- Zone: 553, ID: 55
-- Type: MOB, Flags: SPEECH_TO
-- Status: CLEAN
--
-- Original DG Script: #55355

-- Converted from DG Script #55355: phase_2_cleric_gauntlets
...
if (actor.class == "cleric" or actor.class == "priest") and actor.level >= 21 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    actor:send(tostring(self.name) .. " tells you, \"cleric types but I'll need 3 quantities of some topaz dust, and\"")
