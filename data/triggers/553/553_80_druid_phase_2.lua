...
if actor.class == "class" and actor.level >= 21 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    local vnum_reward_helm = 47
    local vnum_reward_arms = 48
    local vnum_reward_chest = 49
    local vnum_reward_legs = 50
    local vnum_reward_boots = 51
    local vnum_reward_bracer = 52
    local vnum_reward_gloves = 53
    -- 
