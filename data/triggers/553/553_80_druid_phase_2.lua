-- Trigger: druid_phase_2
-- Zone: 553, ID: 80
-- Type: MOB, Flags: RECEIVE
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <druid_phase_2>:112: function arguments expected near ']'
--   Complex nesting: 15 if statements
--   Large script: 10429 chars
--
-- Original DG Script: #55380

-- Converted from DG Script #55380: druid_phase_2
...
if actor.class == "class" and actor.level >= 21 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    local id_reward_helm = 47
    local id_reward_arms = 48
    local id_reward_chest = 49
    local id_reward_legs = 50
    local id_reward_boots = 51
    local id_reward_bracer = 52
    local id_reward_gloves = 53
    -- 
