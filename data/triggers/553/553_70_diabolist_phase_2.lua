...
if actor.class == "class" and actor.level >= 21 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    local vnum_reward_helm = 68
    local vnum_reward_arms = 69
    local vnum_reward_chest = 70
    local vnum_reward_legs = 71
    local vnum_reward_boots = 72
    local vnum_reward_bracer = 73
    local vnum_reward_gloves = 74
    -- 
