-- Trigger: rogue_phase_1
-- Zone: 553, ID: 40
-- Type: MOB, Flags: RECEIVE
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <rogue_phase_1>:112: function arguments expected near ']'
--   Complex nesting: 15 if statements
--   Large script: 10524 chars
--
-- Original DG Script: #55340

-- Converted from DG Script #55340: rogue_phase_1
...
if ROG_SUB and actor.level >= 1 and actor:get_quest_stage("phase_armor") >= 1 then
    ...
    -- destroyed armor
    local id_destroyed_gloves = 55301
    local id_destroyed_chest = 55325
    local id_destroyed_boots = 55305
    local id_destroyed_bracer = 55309
    local id_destroyed_helm = 55313
    local id_destroyed_arm = 55317
    local id_destroyed_legs = 55321
    -- gems for this class
    local id_gem_gloves = 55568
    local id_gem_boots = 55572
    local id_gem_bracer = 55576
    local id_gem_helm = 55580
    local id_gem_arm = 55584
    local id_gem_legs = 55588
    local id_gem_chest = 55592
    -- rewards for this class
    local id_reward_helm = 5
    local id_reward_arms = 6
    local id_reward_chest = 7
    local id_reward_legs = 8
    local id_reward_boots = 9
    local id_reward_bracer = 10
    local id_reward_gloves = 11
    -- 
