-- Trigger: phase_2_diabolist_greet
-- Zone: 553, ID: 61
-- Type: MOB, Flags: GREET
-- Status: CLEAN
--
-- Original DG Script: #55361

-- Converted from DG Script #55361: phase_2_diabolist_greet
-- Original: MOB trigger, flags: GREET, probability: 100%
wait(2)
if actor.class == "diabolist" and actor.level >= 21 then
