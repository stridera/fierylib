-- Trigger: phase_2_necromancer_greet
-- Zone: 553, ID: 91
-- Type: MOB, Flags: GREET
-- Status: CLEAN
--
-- Original DG Script: #55391

-- Converted from DG Script #55391: phase_2_necromancer_greet
-- Original: MOB trigger, flags: GREET, probability: 100%
wait(2)
if actor.class == "necromancer" and actor.level >= 21 then
