-- Trigger: phase_2_diabolist_helm
-- Zone: 553, ID: 64
-- Type: MOB, Flags: SPEECH_TO
-- Status: CLEAN
--
-- Original DG Script: #55364

-- Converted from DG Script #55364: phase_2_diabolist_helm
...
if actor.class == "diabolist" and actor.level >= 21 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    actor:send(tostring(self.name) .. " tells you, \"but I'll need 3 cursed tourmalines, and a Crushed\"")
