-- Trigger: anti-paladin_phase_2
-- Zone: 553, ID: 50
-- Type: MOB, Flags: RECEIVE
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <anti-paladin_phase_2>:112: function arguments expected near ']'
--   Complex nesting: 15 if statements
--   Large script: 10443 chars
--
-- Original DG Script: #55350

-- Converted from DG Script #55350: anti-paladin_phase_2
...
if actor.class == "class" and actor.level >= 21 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    -- gems for this class
    local id_gem_gloves = 55594
    local id_gem_boots = 55605
    local id_gem_bracer = 55616
    local id_gem_helm = 55627
    local id_gem_arm = 55638
    local id_gem_legs = 55649
    local id_gem_chest = 55660
    -- rewards for this class
    local id_reward_helm = 26
    local id_reward_arms = 27
    local id_reward_chest = 28
    local id_reward_legs = 29
    local id_reward_boots = 30
    local id_reward_bracer = 31
    local id_reward_gloves = 32
    -- 
