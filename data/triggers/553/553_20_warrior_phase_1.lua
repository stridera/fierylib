...
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <warrior_phase_1>:113: function arguments expected near ']'
...
if WARRIOR_SUB and actor.level >= 1 and actor:get_quest_stage("phase_armor") >= 1 then
    ...
    -- destroyed armor
    local id_destroyed_gloves = 55300
    local id_destroyed_boots = 55304
    local id_destroyed_bracer = 55308
    local id_destroyed_helm = 55312
    local id_destroyed_arm = 55316
    local id_destroyed_legs = 55320
    local id_destroyed_chest = 55324
    -- gems for this class
    local id_gem_gloves = 55569
    local id_gem_boots = 55573
    local id_gem_bracer = 55577
    local id_gem_helm = 55581
    local id_gem_arm = 55585
    local id_gem_legs = 55589
    local id_gem_chest = 55593
    -- rewards for this class
    local id_reward_helm = 84
    local id_reward_arms = 85
    local id_reward_chest = 86
    local id_reward_legs = 87
    local id_reward_boots = 88
    local id_reward_bracer = 89
    local id_reward_gloves = 90
    -- 
    ...
    if not is_armor then
        ...
        if gems == 3 and actor.quest_variable[phase_armor:team_a_idrmor_armor_acquired] == 1 then
            ...
            wait(1)
            self.room:spawn_object(553, id_reward)
            wait(1)
            -- 
            -- loop for exp award.
            -- 
