-- Trigger: cleric_phase_2
-- Zone: 553, ID: 60
-- Type: MOB, Flags: RECEIVE
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <cleric_phase_2>:111: function arguments expected near ']'
--   Complex nesting: 15 if statements
--   Large script: 10438 chars
--
-- Original DG Script: #55360

-- Converted from DG Script #55360: cleric_phase_2
...
if (actor.class == "cleric" or actor.class == "priest") and actor.level >= 21 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    -- gems for this class
    local id_gem_gloves = 55601
    local id_gem_boots = 55612
    local id_gem_bracer = 55623
    local id_gem_helm = 55634
    local id_gem_arm = 55645
    local id_gem_legs = 55656
    local id_gem_chest = 55667
    -- rewards for this class
    local id_reward_helm = 33
    local id_reward_arms = 34
    local id_reward_chest = 35
    local id_reward_legs = 36
    local id_reward_boots = 37
    local id_reward_bracer = 38
    local id_reward_gloves = 39
    -- 
