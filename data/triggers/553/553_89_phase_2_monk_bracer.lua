-- Trigger: phase_2_monk_bracer
-- Zone: 553, ID: 89
-- Type: MOB, Flags: SPEECH_TO
-- Status: CLEAN
--
-- Original DG Script: #55389

-- Converted from DG Script #55389: phase_2_monk_bracer
...
if actor.class == "monk" and actor.level >= 21 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    actor:send(tostring(self.name) .. " tells you, \"monk types but I'll need 3 flawed turquoises, and a Burned Wristband.\"")
