...
if actor.class == "class" and actor.level >= 21 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    local vnum_reward_helm = 19
    local vnum_reward_arms = 20
    local vnum_reward_chest = 21
    local vnum_reward_legs = 22
    local vnum_reward_boots = 23
    local vnum_reward_bracer = 24
    local vnum_reward_gloves = 25
    -- 
