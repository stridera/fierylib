-- Trigger: paladin_phase_2
-- Zone: 554, ID: 10
-- Type: MOB, Flags: RECEIVE
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <paladin_phase_2>:112: function arguments expected near ']'
--   Complex nesting: 15 if statements
--   Large script: 10433 chars
--
-- Original DG Script: #55410

-- Converted from DG Script #55410: paladin_phase_2
...
if actor.class == "class" and actor.level >= 21 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    -- gems for this class
    local id_gem_gloves = 55599
    local id_gem_boots = 55610
    local id_gem_bracer = 55621
    local id_gem_helm = 55632
    local id_gem_arm = 55643
    local id_gem_legs = 55654
    local id_gem_chest = 55665
    -- rewards for this class
    local id_reward_helm = 19
    local id_reward_arms = 20
    local id_reward_chest = 21
    local id_reward_legs = 22
    local id_reward_boots = 23
    local id_reward_bracer = 24
    local id_reward_gloves = 25
    -- 
