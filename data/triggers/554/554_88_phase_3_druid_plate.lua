-- Trigger: phase_3_druid_plate
-- Zone: 554, ID: 88
-- Type: MOB, Flags: SPEECH_TO
-- Status: CLEAN
--
-- Original DG Script: #55488

-- Converted from DG Script #55488: phase_3_druid_plate
...
if actor.class == "druid" and actor.level >= 41 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    actor:send(tostring(self.name) .. " tells you, \"I'll need 3 enchanted diamonds, and a Corroded Jerkin. Return these\"")
