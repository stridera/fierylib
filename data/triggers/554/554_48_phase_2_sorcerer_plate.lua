-- Trigger: phase_2_sorcerer_plate
-- Zone: 554, ID: 48
-- Type: MOB, Flags: SPEECH_TO
-- Status: CLEAN
--
-- Original DG Script: #55448

-- Converted from DG Script #55448: phase_2_sorcerer_plate
...
if (actor.class == "sorcerer" or actor.class == "cryomancer" or actor.class == "pyromancer") and actor.level >= 21 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    actor:send(tostring(self.name) .. " tells you, \"I'll need 3 flawed emeralds, and a Burned Robe. Return these\"")
