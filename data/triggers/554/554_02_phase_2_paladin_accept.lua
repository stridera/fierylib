-- Trigger: Phase_2_paladin_accept
-- Zone: 554, ID: 2
-- Type: MOB, Flags: SPEECH_TO
-- Status: CLEAN
--
-- Original DG Script: #55402

-- Converted from DG Script #55402: Phase_2_paladin_accept
...
if actor.class == "paladin" then
    ...
    actor:send(tostring(self.name) .. " tells you, \"Sorry, this quest is for paladins only.\"")
end