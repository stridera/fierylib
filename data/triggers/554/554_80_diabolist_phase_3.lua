...
if actor.class == "class" and actor.level >= 41 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    local vnum_reward_helm = 45
    local vnum_reward_arms = 46
    local vnum_reward_chest = 47
    local vnum_reward_legs = 48
    local vnum_reward_boots = 49
    local vnum_reward_bracer = 50
    local vnum_reward_gloves = 51
    -- 
