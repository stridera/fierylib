-- Trigger: diabolist_phase_3
-- Zone: 554, ID: 80
-- Type: MOB, Flags: RECEIVE
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <diabolist_phase_3>:112: function arguments expected near ']'
--   Complex nesting: 15 if statements
--   Large script: 10441 chars
--
-- Original DG Script: #55480

-- Converted from DG Script #55480: diabolist_phase_3
...
if actor.class == "class" and actor.level >= 41 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    -- gems for this class
    local id_gem_gloves = 55672
    local id_gem_boots = 55683
    local id_gem_bracer = 55694
    local id_gem_helm = 55705
    local id_gem_arm = 55716
    local id_gem_legs = 55727
    local id_gem_chest = 55738
    -- rewards for this class
    local id_reward_helm = 45
    local id_reward_arms = 46
    local id_reward_chest = 47
    local id_reward_legs = 48
    local id_reward_boots = 49
    local id_reward_bracer = 50
    local id_reward_gloves = 51
    -- 
