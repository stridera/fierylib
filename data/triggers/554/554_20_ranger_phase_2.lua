-- Trigger: ranger_phase_2
-- Zone: 554, ID: 20
-- Type: MOB, Flags: RECEIVE
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <ranger_phase_2>:112: function arguments expected near ']'
--   Complex nesting: 15 if statements
--   Large script: 10431 chars
--
-- Original DG Script: #55420

-- Converted from DG Script #55420: ranger_phase_2
...
if actor.class == "class" and actor.level >= 21 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    -- destroyed armor
    local id_destroyed_gloves = 55329
    local id_destroyed_boots = 55333
    local id_destroyed_bracer = 55337
    local id_destroyed_helm = 55341
    local id_destroyed_arm = 55345
    local id_destroyed_legs = 55349
    local id_destroyed_chest = 55353
    -- gems for this class
    local id_gem_gloves = 55600
    local id_gem_boots = 55611
    local id_gem_bracer = 55622
    local id_gem_helm = 55633
    local id_gem_arm = 55644
    local id_gem_legs = 55655
    local id_gem_chest = 55666
    -- rewards for this class
    local id_reward_helm = 40
    local id_reward_arms = 41
    local id_reward_chest = 42
    local id_reward_legs = 43
    local id_reward_boots = 44
    local id_reward_bracer = 45
    local id_reward_gloves = 46
    -- 
