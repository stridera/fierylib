...
if actor.class == "class" and actor.level >= 21 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    local vnum_reward_helm = 40
    local vnum_reward_arms = 41
    local vnum_reward_chest = 42
    local vnum_reward_legs = 43
    local vnum_reward_boots = 44
    local vnum_reward_bracer = 45
    local vnum_reward_gloves = 46
    -- 
