-- Trigger: phase_3_druid_greaves
-- Zone: 554, ID: 87
-- Type: MOB, Flags: SPEECH_TO
-- Status: CLEAN
--
-- Original DG Script: #55487

-- Converted from DG Script #55487: phase_3_druid_greaves
...
if actor.class == "druid" and actor.level >= 41 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    actor:send(tostring(self.name) .. " tells you, \"pants for the druid types but I'll need 3 enchanted opals,\"")
