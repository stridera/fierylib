-- Trigger: phase_2_rogue_helm
-- Zone: 554, ID: 24
-- Type: MOB, Flags: SPEECH_TO
-- Status: CLEAN
--
-- Original DG Script: #55424

-- Converted from DG Script #55424: phase_2_rogue_helm
...
if (actor.class == "rogue" or actor.class == "thief" or actor.class == "assassin" or actor.class == "mercenary") and actor.level >= 21 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    actor:send(tostring(self.name) .. " tells you, \"but I'll need 3 perfect lapis-lazulis, and a Crushed Coif.\"")
