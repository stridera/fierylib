-- Trigger: warrior_phase_2
-- Zone: 554, ID: 40
-- Type: MOB, Flags: RECEIVE
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <warrior_phase_2>:112: function arguments expected near ']'
--   Complex nesting: 15 if statements
--   Large script: 10433 chars
--
-- Original DG Script: #55440

-- Converted from DG Script #55440: warrior_phase_2
...
if actor.class == "class" and actor.level >= 21 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    -- gems for this class
    local id_gem_gloves = 55604
    local id_gem_boots = 55615
    local id_gem_bracer = 55626
    local id_gem_helm = 55637
    local id_gem_arm = 55648
    local id_gem_legs = 55659
    local id_gem_chest = 55670
    -- rewards for this class
    local id_reward_helm = 12
    local id_reward_arms = 13
    local id_reward_chest = 14
    local id_reward_legs = 15
    local id_reward_boots = 16
    local id_reward_bracer = 17
    local id_reward_gloves = 18
    -- 
