...
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <**UNUSED**>:111: function arguments expected near ']'
--   Complex nesting: 15 if statements
--   Large script: 10438 chars
--
-- Original DG Script: #55470

-- Converted from DG Script #55470: **UNUSED**
...
if (actor.class == "cleric" or actor.class == "priest") and actor.level >= 41 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    -- gems for this class
    local id_gem_gloves = 55678
    local id_gem_boots = 55689
    local id_gem_bracer = 55700
    local id_gem_helm = 55711
    local id_gem_arm = 55722
    local id_gem_legs = 55733
    local id_gem_chest = 55744
    -- rewards for this class
    local id_reward_helm = 10
    local id_reward_arms = 11
    local id_reward_chest = 12
    local id_reward_legs = 13
    local id_reward_boots = 14
    local id_reward_bracer = 15
    local id_reward_gloves = 16
    -- 
