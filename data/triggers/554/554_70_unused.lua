...
if (actor.class == "cleric" or actor.class == "priest") and actor.level >= 41 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    local vnum_reward_helm = 10
    local vnum_reward_arms = 11
    local vnum_reward_chest = 12
    local vnum_reward_legs = 13
    local vnum_reward_boots = 14
    local vnum_reward_bracer = 15
    local vnum_reward_gloves = 16
    -- 
