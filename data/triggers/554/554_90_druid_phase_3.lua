...
if actor.class == "class" and actor.level >= 41 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    local vnum_reward_helm = 24
    local vnum_reward_arms = 25
    local vnum_reward_chest = 26
    local vnum_reward_legs = 27
    local vnum_reward_boots = 28
    local vnum_reward_bracer = 29
    local vnum_reward_gloves = 30
    -- 
