-- Trigger: druid_phase_3
-- Zone: 554, ID: 90
-- Type: MOB, Flags: RECEIVE
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <druid_phase_3>:112: function arguments expected near ']'
--   Complex nesting: 15 if statements
--   Large script: 10433 chars
--
-- Original DG Script: #55490

-- Converted from DG Script #55490: druid_phase_3
...
if actor.class == "class" and actor.level >= 41 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    -- destroyed armor
    local id_destroyed_gloves = 55358
    local id_destroyed_boots = 55362
    local id_destroyed_bracer = 55366
    local id_destroyed_helm = 55370
    local id_destroyed_arm = 55374
    local id_destroyed_legs = 55378
    local id_destroyed_chest = 55382
    -- gems for this class
    local id_gem_gloves = 55673
    local id_gem_boots = 55684
    local id_gem_bracer = 55695
    local id_gem_helm = 55706
    local id_gem_arm = 55717
    local id_gem_legs = 55728
    local id_gem_chest = 55739
    -- rewards for this class
    local id_reward_helm = 24
    local id_reward_arms = 25
    local id_reward_chest = 26
    local id_reward_legs = 27
    local id_reward_boots = 28
    local id_reward_bracer = 29
    local id_reward_gloves = 30
    -- 
