-- Trigger: phase_2_paladin_greet
-- Zone: 554, ID: 1
-- Type: MOB, Flags: GREET
-- Status: CLEAN
--
-- Original DG Script: #55401

-- Converted from DG Script #55401: phase_2_paladin_greet
-- Original: MOB trigger, flags: GREET, probability: 100%
wait(2)
if actor.class == "paladin" and actor.level >= 21 then
