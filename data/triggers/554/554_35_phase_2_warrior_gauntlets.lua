-- Trigger: phase_2_warrior_gauntlets
-- Zone: 554, ID: 35
-- Type: MOB, Flags: SPEECH_TO
-- Status: CLEAN
--
-- Original DG Script: #55435

-- Converted from DG Script #55435: phase_2_warrior_gauntlets
...
if actor.class == "warrior" and actor.level >= 21 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    actor:send(tostring(self.name) .. " tells you, \"warrior types but I'll need 3 quantities of some sapphire dust, and\"")
