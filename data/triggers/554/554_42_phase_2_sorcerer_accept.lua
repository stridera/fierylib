-- Trigger: Phase_2_sorcerer_accept
-- Zone: 554, ID: 42
-- Type: MOB, Flags: SPEECH_TO
-- Status: CLEAN
--
-- Original DG Script: #55442

-- Converted from DG Script #55442: Phase_2_sorcerer_accept
...
if actor.class == "sorcerer" or actor.class == "cryomancer" or actor.class == "pyromancer" then
    ...
    actor:send(tostring(self.name) .. " tells you, \"Excellent, I can make nice <b:white>slippers</>, a <b:white>coif</>, <b:white>gloves</>,\"")
