-- Trigger: phase_3_sorcerer_greaves
-- Zone: 554, ID: 97
-- Type: MOB, Flags: SPEECH_TO
-- Status: CLEAN
--
-- Original DG Script: #55497

-- Converted from DG Script #55497: phase_3_sorcerer_greaves
...
if (actor.class == "sorcerer" or actor.class == "cryomancer" or actor.class == "pyromancer") and actor.level >= 41 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    actor:send(tostring(self.name) .. " tells you, \"pants for the sorcerer types but I'll need 3 handfulls of sapphires,\"")
