-- Trigger: anti-paladin_phase_3
-- Zone: 554, ID: 60
-- Type: MOB, Flags: RECEIVE
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <anti-paladin_phase_3>:112: function arguments expected near ']'
--   Complex nesting: 15 if statements
--   Large script: 10447 chars
--
-- Original DG Script: #55460

-- Converted from DG Script #55460: anti-paladin_phase_3
...
if actor.class == "class" and actor.level >= 41 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    local id_reward_helm = 3
    local id_reward_arms = 4
    local id_reward_chest = 5
    local id_reward_legs = 6
    local id_reward_boots = 7
    local id_reward_bracer = 8
    local id_reward_gloves = 9
    -- 
