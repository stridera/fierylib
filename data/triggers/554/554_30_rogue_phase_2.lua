...
if (actor.class == "rogue" or actor.class == "thief" or actor.class == "assassin" or actor.class == "mercenary") and actor.level >= 21 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    local vnum_reward_helm = 82
    local vnum_reward_arms = 83
    local vnum_reward_chest = 84
    local vnum_reward_legs = 85
    local vnum_reward_boots = 86
    local vnum_reward_bracer = 87
    local vnum_reward_gloves = 88
    -- 
