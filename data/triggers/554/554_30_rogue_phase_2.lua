...
-- Status: NEEDS_REVIEW
--   Syntax error: luac: <rogue_phase_2>:111: function arguments expected near ']'
...
if (actor.class == "rogue" or actor.class == "thief" or actor.class == "assassin" or actor.class == "mercenary") and actor.level >= 21 and actor:get_quest_stage("phase_armor") >= 2 then
    ...
    -- gems for this class
    local id_gem_gloves = 55603
    local id_gem_boots = 55614
    local id_gem_bracer = 55625
    local id_gem_helm = 55636
    local id_gem_arm = 55647
    local id_gem_legs = 55658
    local id_gem_chest = 55669
    -- rewards for this class
    local id_reward_helm = 82
    local id_reward_arms = 83
    local id_reward_chest = 84
    local id_reward_legs = 85
    local id_reward_boots = 86
    local id_reward_bracer = 87
    local id_reward_gloves = 88
    -- 
