-- Trigger: Phase_3_druid_accept
-- Zone: 554, ID: 82
-- Type: MOB, Flags: SPEECH_TO
-- Status: CLEAN
--
-- Original DG Script: #55482

-- Converted from DG Script #55482: Phase_3_druid_accept
...
if actor.class == "druid" then
    ...
    actor:send(tostring(self.name) .. " tells you, \"Sorry, this quest is for druids only.\"")
end