...
elseif string.find(speech, "flimsy") then
    if string.find(speech, "gloves") then
        local armor_id = 55301
    elseif string.find(speech, "boots") then
        local armor_id = 55305
    elseif string.find(speech, "bracer") then
        local armor_id = 55309
    elseif string.find(speech, "cap") then
        local armor_id = 55313
    elseif string.find(speech, "sleeves") then
        local armor_id = 55317
    elseif string.find(speech, "leggings") then
        local armor_id = 55321
    elseif string.find(speech, "tunic") then
        local armor_id = 55325
    end
elseif string.find(speech, "decayed") then
    if string.find(speech, "mittens") then
        local armor_id = 55302
    elseif string.find(speech, "slippers") then
        local armor_id = 55306
    elseif string.find(speech, "bracelet") then
        local armor_id = 55310
    elseif string.find(speech, "turban") then
        local armor_id = 55314
    elseif string.find(speech, "sleeves") then
        local armor_id = 55318
    elseif string.find(speech, "leggings") then
        local armor_id = 55322
    elseif string.find(speech, "robe") then
        local armor_id = 55326
    end
elseif string.find(speech, "crushed") then
    if string.find(speech, "leather") then
        if string.find(speech, "gloves") then
            local armor_id = 55329
        elseif string.find(speech, "boots") then
            local armor_id = 55333
        elseif string.find(speech, "bracer") then
            local armor_id = 55337
        elseif string.find(speech, "sleeves") then
            local armor_id = 55345
        elseif string.find(speech, "leggings") then
            local armor_id = 55349
        elseif string.find(speech, "tunic") then
            local armor_id = 55353
        end
    elseif string.find(speech, "hood") then
        local armor_id = 55341
    elseif string.find(speech, "plate") then
        if string.find(speech, "boots") then
            local armor_id = 55332
        elseif string.find(speech, "bracer") then
            local armor_id = 55336
        else
            local armor_id = 55352
        end
    elseif string.find(speech, "gauntlets") then
        local armor_id = 55328
    elseif string.find(speech, "helm") then
        local armor_id = 55340
    elseif string.find(speech, "vambraces") then
        local armor_id = 55344
    elseif string.find(speech, "greaves") then
        local armor_id = 55348
    end
elseif string.find(speech, "burned") then
    if string.find(speech, "gloves") then
        local armor_id = 55330
    elseif string.find(speech, "mittens") then
        local armor_id = 55331
    elseif string.find(speech, "boots") then
        local armor_id = 55334
    elseif string.find(speech, "slippers") then
        local armor_id = 55335
    elseif string.find(speech, "wristband") then
        local armor_id = 55338
    elseif string.find(speech, "bracelet") then
        local armor_id = 55339
    elseif string.find(speech, "cap") then
        local armor_id = 55342
    elseif string.find(speech, "turban") then
        local armor_id = 55343
    elseif string.find(speech, "vambraces") then
        local armor_id = 55346
    elseif string.find(speech, "sleeves") then
        local armor_id = 55347
    elseif string.find(speech, "pants") then
        local armor_id = 55350
    elseif string.find(speech, "leggings") then
        local armor_id = 55351
    elseif string.find(speech, "jerkin") then
        local armor_id = 55354
    elseif string.find(speech, "robe") then
        local armor_id = 55355
    end
elseif string.find(speech, "tarnished") then
    if string.find(speech, "plate") then
        if string.find(speech, "boots") then
            local armor_id = 55360
        elseif string.find(speech, "bracer") then
            local armor_id = 55364
        else
            local armor_id = 55380
        end
    elseif string.find(speech, "boots") then
        local armor_id = 55360
    elseif string.find(speech, "bracer") then
        local armor_id = 55364
    elseif string.find(speech, "gauntlets") then
        local armor_id = 55356
    elseif string.find(speech, "helm") then
        local armor_id = 55368
    elseif string.find(speech, "vambraces") then
        local armor_id = 55372
    elseif string.find(speech, "greaves") then
        local armor_id = 55376
    end
elseif string.find(speech, "worn") then
    if string.find(speech, "mittens") then
        local armor_id = 55359
    elseif string.find(speech, "slippers") then
        local armor_id = 55363
    elseif string.find(speech, "bracelet") then
        local armor_id = 55367
    elseif string.find(speech, "turban") then
        local armor_id = 55371
    elseif string.find(speech, "sleeves") then
        local armor_id = 55375
    elseif string.find(speech, "leggings") then
        local armor_id = 55379
    elseif string.find(speech, "robe") then
        local armor_id = 55383
    end
elseif string.find(speech, "corroded") then
    if string.find(speech, "gloves") then
        local armor_id = 55358
    elseif string.find(speech, "boots") then
        local armor_id = 55362
    elseif string.find(speech, "wristband") then
        local armor_id = 55366
    elseif string.find(speech, "cap") then
        local armor_id = 55370
    elseif string.find(speech, "vambraces") then
        local armor_id = 55374
    elseif string.find(speech, "pants") then
        local armor_id = 55378
    elseif string.find(speech, "jerkin") then
        local armor_id = 55382
    end
elseif string.find(speech, "creased") then
    if string.find(speech, "gloves") then
        local armor_id = 55357
    elseif string.find(speech, "boots") then
        local armor_id = 55361
    elseif string.find(speech, "bracer") then
        local armor_id = 55365
    elseif string.find(speech, "hood") then
        local armor_id = 55369
    elseif string.find(speech, "sleeves") then
        local armor_id = 55373
    elseif string.find(speech, "leggings") then
        local armor_id = 55377
    elseif string.find(speech, "tunic") then
        local armor_id = 55381
    end
end
if not armor_id then
    actor:send(tostring(self.name) .. " tells you, 'I'm sorry, I don't know what that is.'")
else
    actor:send(tostring(self.name) .. " asks you, 'You want " .. "%get.obj_shortdesc[%armor_id%]%?'")
    actor:set_quest_var("armor_exchange", "armor_id", armor_id)
end