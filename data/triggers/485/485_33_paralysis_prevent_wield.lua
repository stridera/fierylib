-- Trigger: paralysis_prevent_wield
-- Zone: 485, ID: 33
-- Type: MOB, Flags: COMMAND
-- Status: CLEAN
--
-- Original DG Script: #48533

-- Converted from DG Script #48533: paralysis_prevent_wield
-- Original: MOB trigger, flags: COMMAND, probability: 100%

-- Command filter: qield
if not (cmd == "qield") then
