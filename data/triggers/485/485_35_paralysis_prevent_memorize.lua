-- Trigger: paralysis_prevent_memorize
-- Zone: 485, ID: 35
-- Type: MOB, Flags: COMMAND
-- Status: CLEAN
--
-- Original DG Script: #48535

-- Converted from DG Script #48535: paralysis_prevent_memorize
-- Original: MOB trigger, flags: COMMAND, probability: 100%

-- Command filter: memorize
if not (cmd == "memorize") then
