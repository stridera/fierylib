...
-- Reports the player's current dragons_health quest progress when they say
-- "progress" or "status" near Myorrhed. Each stage prints the active dragon
-- target plus the per-stage sub-objectives still outstanding.
...
local dragon, treasure
if stage == 1 then
    dragon = "the blue dragon in the Tower in the Wastes"
    treasure = "its crystal"
elseif stage == 2 then
    dragon = "Tri-Aszp"
    treasure = "one of her scales"
elseif stage == 3 then
    dragon = "Thelriki and Jerajai"
    treasure = "the jewel in their hoard"
elseif stage == 4 then
    dragon = "Sagece"
    treasure = "her skins and shields"
elseif stage == 5 then
    local total = 10000000 - (actor:get_quest_var("dragons_health:hoard") or 0)
